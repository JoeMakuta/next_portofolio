        ...
        <div className="flex justify-center items-center ">
          <div className="sm:col-span-2">
            ...
            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              ...
              <button className=" transition-all animate-text bg-gradient-to-bl  from-white dark:from-slate-400 dark:to-my_orange  to-my_orange hover:scale-105 w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white duration-300 transform md:w-auto md:mx-4 focus:outline-none bg-gray-800 rounded-lg hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80">
                Subscribe
              </button>
            </div>
          </div>
